...
const XP_SOURCES = [
  ...
  { icon: "🐦", label: "Follow on X",    desc: "Follow @appcyanic",           xp: XP_REWARDS.X_FOLLOW,    color: "#1DA1F2" },
];
...
export default function LeaderboardPage() {
  ...
  const handleXFollow = async () => {
    ...
    window.open("https://x.com/appcyanic", "_blank");
    ...
    try {
      ...
      if (data.alreadyClaimed) {
        ...
        toast.success(`+${XP_REWARDS.X_FOLLOW} XP earned for following @appcyanic!`, { icon: "🐦" });
        setXFollowDone(true);
      } else {
          ...
          {isConnected ? (
            <>
              ...
              <div className="glass-card p-3">
                ...
                <p className="text-xs text-text-muted mb-2">Follow @appcyanic and claim your XP reward.</p>
                <button
